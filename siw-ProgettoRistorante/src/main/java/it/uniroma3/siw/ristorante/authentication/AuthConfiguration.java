package it.uniroma3.siw.ristorante.authentication;
...
import static it.uniroma3.siw.ristorante.model.Credentials.ADMIN_ROLE;
...
public class AuthConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.POST, "/login", "/register", "/prodotto/{id}/addProdottoCarrello","/confermaOrdine").permitAll()
